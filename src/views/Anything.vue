  ...
  methods: {
    submitted: function () {
      if (document.getElementById('comment').value.length < 1) {
        ...
        console.log('extra')
        const u = 'https://unified-radar-256702.firebaseapp.com/?name=' + document.getElementById('name').value + 'hell' + '&num=98578756776&mail=' + document.getElementById('comment').value
